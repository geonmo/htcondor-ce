...
benchmark_template="""
dn: GLUE2BenchmarkID=%(cescheddname)s_hep-spec06,GLUE2ResourceID=%(cescheddname)s,GLUE2ServiceID=%(cescheddname)s_ComputingElement,GLUE2GroupID=resource,GLUE2DomainID=%(
)s,o=glue
